// Abstract Base Class ka matlb hota hai ek aisa class jisko hm objects banane k liye use nai krte hai...iss class ka matlb hi hota hai ki hm isse dusre classes ko inherit kare---
...
public:
    ...
    virtual void display() = 0; //  do-nothing display--- yeh ek tarah se bolta hai ki hmko tmko "define krna hi pdega" agr jake
};
